                ...
                <div class="container flex max-w-screen-xl">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="grid w-full gap-2 grid-col-4 bg-light py-2 px-2">
                            <a href="javascript:void(0)" class="text-sm-center">Awaiting approval (${requestScope.countPending})</a>
                        </div>
                        <!--information personal pending-->
                        <div class="bg-light p-4 w-full my-3 space-y-2" id="pending">
                                ...
                                <div class="p-4 bg-white rounded flex justify-between ">
                                    ...
                                    <div class="flex flex-column justify-end items-center mb-2 text-base">
                                        <a href="javascript:;" class="py-2 mr-2 flex btn_delete" onclick="toggleDelete('${docP.documentID}')">
                                            <span class="py-2 px-3">REFUSE</span>
                                        </a>
                                        <a href="javascript:;" class="py-2 mr-2 flex btn_edit" onclick="toggleUpdate('${docP.documentID}')">
                                            <span class="py-2 px-3">ACCEPT</span>
                                        </a>
                                    </div>
                                </div>
                            </c:forEach>
                            ...
                            <form action="delete" method="post">
                                ...
                                <div class="modal-body">
                                    <div class="p-4 bg-light rounded flex justify-between">
                                        <h3>Do you want to refuse this document?</h3>
                                    </div>
                                </div>
                                <!--pay--> 
                    ...
                    <div class="modal js-modal-update">
                        <div class="modal-container">
                            <form action="updateFile">
                                <input type="hidden" name="documentID" value="" id="documentIdUpdate">
                                <!--close--> 
                                ...
                                <div class="modal-body">
                                    <div class="p-4 bg-light rounded flex justify-between">
                                        <h3>Do you want to accept this document?</h3>
                                    </div>
                                </div>
                                <!--pay--> 
                                <div class="flex justify-end items-center mb-2 text-base">
                                    ...
                                    <a href="javascript:;" class="py-2 mr-2 flex btn_edit" onclick="hideUpdate()()">
                                        <span class="py-2 px-3 edit">CANCEL</span>
                                    </a>
                                </div>
                            </form>
...
<script type="text/javascript">
                                        ...
                                        const updateClass = document.querySelector('.js-modal-update');
                                        const updateClose = document.querySelector('.js-modal-close-update');
                                        let updateStatus = false;

                                        // thêm class vào modal
                                        function showUpdate() {
                                            updateClass.classList.add('open');
                                        }

                                        //gỡ bỏ class open của modal
                                        function hideUpdate() {
                                            updateClass.classList.remove('open');
                                        }

                                        updateClose.addEventListener('click', hideUpdate);

                                        function toggleUpdate(documentID) {
                                            if (updateStatus) {
                                                hideUpdate();
                                            } else {
                                                showUpdate();
                                                var documentIdUpdate = document.getElementById('documentIdUpdate');
                                                documentIdUpdate.value = documentID;
                                            }
                                        ...
                                        document.addEventListener('DOMContentLoaded', function () {
                                            ...
                                            // Add click event listener to the "Pending" link
                                            pendingLink.addEventListener('click', function () {
                                                // Display the pending section
                                                pendingSection.style.display = 'block';

                                                // Hide the approved section
                                                approvedSection.style.display = 'none';

                                                // Add text-primary class to the Pending link
                                                pendingLink.classList.add('text-primary');

                                                // Remove text-primary class from the Approved link
