...
<html>
    ...
    <body>
        <div id="main">
            ...
            <!-- Begin: slide -->
            <div class="slide">
                <section class="content-slider" id="slider">
                    <!--slide-->
                    <div class="slide-wrapper">
                        <div class="slide-item"><img src="asets/img/4.png"></div>
                        <div class="slide-item"><img src="asets/img/5.png"></div>
                        <div class="slide-item"><img src="asets/img/6.png"></div>
                    </div>
                    <!--content slide-->
                    <div class="slider_text-content">
                        <h2 class="text-content_heading">VA<span style="color: #00A888">DocS</span></h2>
                        <p class="text-content_describe">Top choice of professional readers</p>
                    </div>
                </section>
            </div>
            <!-- End: slide -->
            ...
            <section id="content" class="content">
                ...
                <div class="container">
                    <h3><i class="fa-solid fa-book-open"></i> Featured documents</h3>
                    <div class="p-4 h-a">
                        <div class="grid mt-2 mb-4 grid-col-5 gap-2">
                            <c:forEach items="${requestScope.doc}" var="doc">
                                <div class="p-4 bg-light rounded overflow-hidden space-y-3 relative" style="box-shadow: 3px 3px 2px 2px #CCC;">
