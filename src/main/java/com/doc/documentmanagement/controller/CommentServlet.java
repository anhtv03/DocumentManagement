...
public class CommentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc != null) {
            ...
            User u = user_dao.getUserByEmail(acc.getEmail());
            Comment cmt = new Comment(0, feedContent, u.getUserID(), docId, true);
            cmt_dao.addComment(cmt);
            response.sendRedirect("detail?documentID=" + docId);
        } else {
